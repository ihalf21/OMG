  ...
  projects: [
    {
      ...
      name: 'Проект 1',
      engineers: [
        { id:'e1',  name:'Иванов А.С.',    role:'lead',         regularTask:null,              status:'active',   vacationFrom:null,         vacationTo:null,         experience:{} },
        { id:'e2',  name:'Козлова М.В.',   role:'responsible',  regularTask:'Релиз',           status:'active',   vacationFrom:null,         vacationTo:null,         experience:{'Релиз':5,'Смоук':4,'Синхронизация':3} },
        { id:'e3',  name:'Никонов Д.С.',   role:'engineer',     regularTask:'Регресс',         status:'active',   vacationFrom:null,         vacationTo:null,         experience:{'Регресс':5,'Спецзадачи':3,'Смоук':3} },
        { id:'e4',  name:'Петров И.В.',    role:'engineer',     regularTask:'Синхронизация',   status:'vacation', vacationFrom:'2025-05-08', vacationTo:'2025-05-16', experience:{'Синхронизация':5,'Смоук':3} },
        { id:'e5',  name:'Соколова Е.А.', role:'engineer',     regularTask:'Регресс',         status:'sick',     vacationFrom:null,         vacationTo:null,         experience:{'Регресс':5,'Релиз':3} },
        { id:'e6',  name:'Орлова Е.П.',   role:'engineer',     regularTask:'Регресс',         status:'active',   vacationFrom:null,         vacationTo:null,         experience:{'Регресс':5,'Смоук':5,'Релиз':1} },
        { id:'e7',  name:'Зайцев К.Р.',   role:'intern',       regularTask:'Смоук',           status:'active',   vacationFrom:null,         vacationTo:null,         experience:{'Смоук':3,'Регресс':1} },
        { id:'e8',  name:'Морозова Т.Н.', role:'engineer',     regularTask:'Синхронизация',   status:'active',   vacationFrom:null,         vacationTo:null,         experience:{'Синхронизация':5,'Релиз':3,'Регресс':3} },
        { id:'e9',  name:'Козлов А.В.',   role:'engineer',     regularTask:'Регресс',         status:'active',   vacationFrom:null,         vacationTo:null,         experience:{'Регресс':5,'Спецзадачи':3} },
        { id:'e10', name:'Петухов А.С.',  role:'engineer',     regularTask:'Спецзадачи',      status:'active',   vacationFrom:null,         vacationTo:null,         experience:{'Спецзадачи':5} },
      ],
      tasks: [
